...
- In the browser-based version of **Computing History**, **Chat Playground**, and **Model Coder**, the failsafe "basic" mode uses the Wikipedia API rather than a model to answer questions. Keywords from your input are sent to Wikipedia to search for a relevant article.
...
- [Wikipedia API](https://www.mediawiki.org/wiki/Wikimedia_APIs) used in the computing history, chat playground, and model coder app as a failsafe model alternative when neither WebGPU or wllama are available.
